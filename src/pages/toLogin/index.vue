		...
		<view class="content">
			...
			<view class="password">
				...
				<view class="input-wrap">
					...
					<image v-else :src="noCaptcha" @click="buildCaptcha" mode="" style="width: 200rpx; height: 88rpx;">
					</image>
				</view>
			</view>
			...
			<view class="btn-wrap">
				<view class="btn-item" v-for="item in list">
					<text class="iconfont" :class="item.url"
						style="font-size: 52rpx;position: absolute;left: 36rpx;" :style="{ color: item.color }"></text>
					<text>{{item.text}}</text>
				</view>
			</view>
