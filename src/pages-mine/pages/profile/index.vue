			...
			<view class="content">
				<view class="mailbox">
					...
					<view class="input-wrap">
						<input class="input" :value="userInfo.username" focus placeholder="请输入账号" disabled />
					</view>
				</view>
				<view class="mailbox">
				...
				<view class="mailbox">
					...
					<view class="input-wrap">
						<wd-select-picker style="width: 100%; background-color: #fafafa" v-model="formData.sex"
							:columns="columns" type="radio"></wd-select-picker>
					</view>
				</view>
				<!-- 		<view class="mailbox">
		    ...
		    ></wd-select-picker>
				...
				<view class="mailbox">
					...
					<view class="input-textarea">
						<wd-textarea class="input" v-model="formData.workDescribe" :maxlength="120" clearable
							show-word-limit />
					</view>
				</view>
